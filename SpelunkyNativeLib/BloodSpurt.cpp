...
void BloodSpurt::_ready()
{
	...
	body.Init(Vector2(.15f, .15f), Vector2(0, 0), .1f, 10000, this, level, Vector2((level->Random()-.5f)*500.0f, -1000*level->Random()-500), false, 1, HitboxMask::Nothing, nullptr, nullptr, false, false, nullptr,nullptr);
