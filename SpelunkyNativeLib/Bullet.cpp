...
void Bullet::_ready()
{
	...
	body.Init(Vector2(.2,.2),Vector2(0,0),0,0,this,level,Vector2(0,0),false,1,HitboxMask::Nothing,nullptr,nullptr,true,true,level->bulletImpactSFX,nullptr,HeldItem::Unknown);
}
